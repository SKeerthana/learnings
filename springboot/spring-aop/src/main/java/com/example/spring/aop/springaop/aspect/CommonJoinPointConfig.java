...
public class CommonJoinPointConfig {
    ...
    @Pointcut("com.example.spring.aop.springaop.aspect.CommonJoinPointConfig.businessLayerExecution() " +
            "&& com.example.spring.aop.springaop.aspect.CommonJoinPointConfig.dataLayerExecution()")
    ...
    public void dataLayerExecutionUsingWithin(){}
